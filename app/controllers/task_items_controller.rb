class TaskItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @task_item.save
        format.html { redirect_to @task_item, notice: 'Task item was created.' }
  ...
  def update
    respond_to do |format|
      if @task_item.update(task_item_params)
        format.html { redirect_to @task_item, notice: 'Task item was updated.' }
  ...
  def destroy
    @task_item.destroy
    respond_to do |format|
      format.html { redirect_to task_items_url, notice: 'Task item was deleted.' }
